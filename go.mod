...
require (
	...
	gossip-system v0.0.0-00010101000000-000000000000
)
...
replace github.com/example/grpc-service => ./external/grpc-service

replace gossip-system => ./external/gossip-system
